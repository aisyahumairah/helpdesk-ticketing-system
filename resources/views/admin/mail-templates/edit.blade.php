                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a href="{{ route('admin.mail_templates.index') }}"
                                    class="btn btn-sm btn-secondary text-white"><i class="fa fa-arrow-left"></i> Back to
                                    List</a></li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form action="{{ route('admin.mail_templates.update', $mailTemplate->id) }}" method="POST"
                            class="form-horizontal form-label-left">
                            @csrf
                            @method('PUT')

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Template Name
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name" name="name" required="required"
                                        class="form-control " value="{{ old('name', $mailTemplate->name) }}">
                                    @error('name')
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="subject">Subject <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="subject" name="subject" required="required"
                                        class="form-control " value="{{ old('subject', $mailTemplate->subject) }}">
                                    @error('subject')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="body_html">HTML Body <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-9 col-sm-9 ">
                                    ...
                                    @error('body_html')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Use @{{ placeholder_name }} for dynamic
                                        content.</small>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="available_placeholders">Available Placeholders
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <select id="available_placeholders" name="available_placeholders[]"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select id="is_active" name="is_active" class="form-control select2">
                                        <option value="1"
                                            {{ old('is_active', $mailTemplate->is_active) ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $mailTemplate->is_active) ? '' : 'selected' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                            </div>
