                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (
                                                $mailTemplate->available_placeholders &&
                                                    (is_array($mailTemplate->available_placeholders) || is_object($mailTemplate->available_placeholders)))
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div style="border: 1px solid #ddd; height: 500px; border-radius: 4px; overflow: hidden;">
                                    <iframe srcdoc="{{ $mailTemplate->body_html }}"
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6">
                                <a href="{{ route('admin.mail_templates.edit', $mailTemplate->id) }}"
                                    class="btn btn-primary">Edit Template</a>
                            </div>
                        </div>
                    </div>
                </div>
