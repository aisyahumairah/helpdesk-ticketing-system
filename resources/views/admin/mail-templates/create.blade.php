        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{ route('admin.mail_templates.store') }}" method="POST"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <small class="form-text text-muted">Type and press enter to add placeholders (for
                                        documentation purposes).</small>
                                </div>
                            </div>
