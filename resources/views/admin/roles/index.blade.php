                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                @can('role.create')
                                    <li><a href="{{ route('admin.roles.create') }}" class="btn btn-sm btn-primary text-white"><i
                                                class="fa fa-plus"></i> Create New Role</a></li>
                                @endcan
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($role->permissions->count() > 5)
                                                                <span
                                                                    class="badge bg-secondary">+{{ $role->permissions->count() - 5 }}
                                                                    more</span>
                                                            @endif
                                                        </td>
