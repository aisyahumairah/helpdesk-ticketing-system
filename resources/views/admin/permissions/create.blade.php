        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{ route('admin.permissions.store') }}" method="POST" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="guard_name" name="guard_name" class="form-control" value="web" readonly>
                                </div>
                            </div>
