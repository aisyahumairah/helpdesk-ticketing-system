            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form action="{{ route('password.email') }}" method="POST">
                        ...
                        <p class="text-muted text-center">Enter your email and we'll send you a link to reset your
                            password.</p>
                        ...
                        <div class="separator">
                            <p class="change_link mt-3">
                                Remembered your password? <a href="{{ route('login') }}" class="to_register"> Log in
                                </a>
                            </p>
