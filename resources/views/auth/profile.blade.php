                    ...
                    <form action="{{ route('profile.update') }}" method="POST" class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" id="name" name="name" required="required" class="form-control" value="{{ old('name', $user->name) }}">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="password_confirmation">Confirm Password</label>
                            <div class="col-md-6 col-sm-6">
