                ...
                <div class="x_content">
                    <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="user_id">Requestor (User) <span class="required">*</span></label>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="urgency">Urgency <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                <select name="urgency" id="urgency" class="form-control" required>
                                    <option value="">Select Urgency</option>
                                    @foreach($urgencies as $urgency)
                                        <option value="{{ $urgency->code }}" {{ old('urgency') == $urgency->code ? 'selected' : '' }}>{{ $urgency->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="attachments">Attachments</label>
                            <div class="col-md-6 col-sm-6">
                                <input type="file" id="attachments" name="attachments[]" class="form-control" multiple>
                                <small class="text-muted">You can upload multiple files (Images, PDF, Video). Max size: 10MB per file.</small>
                            </div>
                        </div>
