...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Ticket #{{ $ticket->ticket_id }} - Chat</h3>
        </div>
        <div class="title_right text-end">
            <a href="{{ Auth::user()->hasRole('admin') || Auth::user()->hasRole('it_support') ? route('support.adminshow', $ticket) : route('tickets.show', $ticket) }}" class="btn btn-secondary">
                <i class="fa fa-arrow-left"></i> Back to Ticket
            </a>
            <button class="btn btn-danger" onclick="clearMyMessages()">
                <i class="fa fa-trash"></i> Clear My Messages
            </button>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-comments"></i> Chat with Support</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
