            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li class="{{ request()->is('admin/users*') ? 'active' : '' }}">
                        ...
                        <ul class="nav child_menu" style="display: {{ request()->is('admin/users*') || request()->is('admin/roles*') ? 'block' : 'none' }}">
                            <li class="{{ request()->is('admin/users') ? 'active' : '' }}"><a href="{{ route('admin.users.index') }}">Users</a></li>
                            <li class="{{ request()->is('admin/roles*') ? 'active' : '' }}"><a href="{{ route('admin.roles.index') }}">Roles & Permissions</a></li>
                        </ul>
                    </li>
                    <li class="{{ request()->is('admin/settings*') || request()->is('admin/mail-templates*') ? 'active' : '' }}">
                        <a><i class="fa fa-cog"></i> Settings <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: {{ request()->is('admin/settings*') || request()->is('admin/mail-templates*') ? 'block' : 'none' }}">
                            <li class="{{ request()->is('admin/settings') ? 'active' : '' }}"><a href="{{ route('admin.settings') }}">System Settings</a></li>
                            <li class="{{ request()->is('admin/mail-templates*') ? 'active' : '' }}"><a href="{{ route('admin.mail_templates.index') }}">Mail Templates</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
