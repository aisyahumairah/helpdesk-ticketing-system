        ...
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                ...
                <div class="x_content text-end">
                    <form action="{{ route('support.audit_trails') }}" method="GET" class="row g-3 justify-content-end align-items-end">
                        <div class="col-md-3">
                        ...
                        <tbody>
                            @foreach($trails as $trail)
                                <tr>
                                    ...
                                    <td><span class="badge badge-info">{{ $trail->event }}</span></td>
                                    <td>{{ $trail->details }}</td>
                                    ...
                                    <td>
                                        @if($trail->ticket_id)
                                            ...
                                            @if($ticket)
                                                <a href="{{ route('tickets.show', $ticket) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i> Ticket</a>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
